...
outliers_bons = df_insurance[(df_insurance.CMV>1500)]
...
# os outliers positivos do work_compensation não vão para a df outliers_bons pq não são assim tão elevados
